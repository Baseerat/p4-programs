...
parser parse_bitmap_hdr0 {
    ...
    return select(latest.ids) {
        DUMMY_ID mask 0x3FF00000 : ingress;
        DUMMY_ID mask 0x000FFC00 : ingress;
        DUMMY_ID mask 0x000003FF : ingress;
        default: parse_bitmap_hdr1;
    }
}
